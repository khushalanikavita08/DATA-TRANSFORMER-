CREATE DATABASE DATATRANSFORMERR;
 --CREATE CUSTOMER TABLE

CREATE TABLE Customers_Newss(
...
CREATE TABLE Orders_Newss (
    ...
    REFERENCES Customers_Newss(CustomerID)
);

--INSERT RECORD
INSERT INTO Orders_Newss
...
SELECT
    ...
    o.OrderDate,
    o.TotalAmount
FROM Customers_Newss c
INNER JOIN Orders_Newss o
...
SELECT
    ...
    o.OrderDate,
    o.TotalAmount
FROM Customers_Newss AS c
FULL OUTER JOIN Orders_Newss AS o
ON c.CustomerID = o.CustomerID;
